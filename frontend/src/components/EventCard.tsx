...
type Props = {
  ...
  date: string;
  location: string;
  image: string; // нэмэлт prop
};

const EventCard = ({ title, date, location, image }: Props) => {
  return (
    <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden border border-gray-100 w-[380px]">
      ...
      <div className="p-6">
        ...
        <p className="text-gray-600 mb-4"><span className="font-medium">Location:</span> {location}</p>
        <a 
          href="/event/1" 
